...
## Stage 13
- Максимальный уровень питомца ограничен значением 100.
- На уровне 100 питомец получает легендарный статус (👑 Легенда).
- Кривая опыта стала ступенчатой: высокие уровни требуют значительно больше EXP.
- Максимумы шкал потребностей масштабируются с уровнем и заметно выше на поздних уровнях.


## Stage 13.1
- Добавлена высокоуровневая карта путешествий до уровня 95.
