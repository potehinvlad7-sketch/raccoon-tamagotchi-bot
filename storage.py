...
TRAVEL_LOCATIONS = {
    ...
    "abandoned_watchhut": {"button": "🌲 Заброшенная сторожка", "name": "Заброшенная сторожка", "min_level": 8, "costs": {"energy": 38, "satiety": 20, "cleanliness": 14}, "rewards": {"exp": 30, "currency": 16}},
    "glowing_mushroom_grove": {"button": "🍄 Светящийся грибной бор", "name": "Светящийся грибной бор", "min_level": 12, "costs": {"energy": 48, "satiety": 25, "cleanliness": 18}, "rewards": {"exp": 42, "currency": 22}},
    "foggy_swamp": {"button": "🌫 Туманное болото", "name": "Туманное болото", "min_level": 18, "costs": {"energy": 58, "satiety": 30, "cleanliness": 24}, "rewards": {"exp": 58, "currency": 30}},
    "stone_pass": {"button": "🪨 Каменный перевал", "name": "Каменный перевал", "min_level": 25, "costs": {"energy": 72, "satiety": 35, "cleanliness": 26}, "rewards": {"exp": 78, "currency": 40}},
    "old_settlement_ruins": {"button": "🏚 Руины старого поселения", "name": "Руины старого поселения", "min_level": 35, "costs": {"energy": 88, "satiety": 44, "cleanliness": 34}, "rewards": {"exp": 105, "currency": 56}},
    "starry_thicket": {"button": "🌌 Звёздная чаща", "name": "Звёздная чаща", "min_level": 45, "costs": {"energy": 106, "satiety": 50, "cleanliness": 40, "love": 16}, "rewards": {"exp": 132, "currency": 70}},
    "underground_roots": {"button": "🕯 Подземные корни", "name": "Подземные корни", "min_level": 55, "costs": {"energy": 126, "satiety": 60, "cleanliness": 52}, "rewards": {"exp": 165, "currency": 88}},
    "giants_graveyard": {"button": "🦴 Кладбище великанов", "name": "Кладбище великанов", "min_level": 65, "costs": {"energy": 148, "satiety": 72, "cleanliness": 60}, "rewards": {"exp": 205, "currency": 110}},
    "forgotten_raccoon_castle": {"button": "🏰 Забытый енотовый замок", "name": "Забытый енотовый замок", "min_level": 75, "costs": {"energy": 170, "satiety": 84, "cleanliness": 68, "love": 24}, "rewards": {"exp": 250, "currency": 138}},
    "black_grove": {"button": "🌑 Чёрная роща", "name": "Чёрная роща", "min_level": 85, "costs": {"energy": 192, "satiety": 96, "cleanliness": 78, "love": 30}, "rewards": {"exp": 305, "currency": 170}},
    "path_of_legends": {"button": "👑 Тропа легенд", "name": "Тропа легенд", "min_level": 95, "costs": {"energy": 220, "satiety": 110, "cleanliness": 90, "love": 36}, "rewards": {"exp": 370, "currency": 210}},
}
...
LOCATION_ENEMIES = {
    ...
    "abandoned_watchhut": ["watch_owl", "house_spider", "mushroom_goblin"],
    "glowing_mushroom_grove": ["mushroom_shaman", "glowing_slime", "mushroom_goblin"],
    "foggy_swamp": ["swamp_snake", "bog_predator", "swamp_rat"],
    "stone_pass": ["mountain_marten", "stone_beetle"],
    "old_settlement_ruins": ["raider_rat", "pantry_spirit", "watch_owl"],
    "starry_thicket": ["star_owl", "night_badger"],
    "underground_roots": ["root_worm", "moss_guardian"],
    "giants_graveyard": ["bone_weasel", "skull_raven"],
    "forgotten_raccoon_castle": ["ghost_raccoon_knight", "armored_rat"],
    "black_grove": ["shadow_marten", "cursed_owl"],
    "path_of_legends": ["legend_keeper", "ancient_raccoon", "ghost_raccoon_knight"],
}
